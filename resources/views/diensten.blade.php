        ...
        <div class="flex flex-row flex-wrap justify-evenly m-6 bg-white rounded-xl drop-shadow-2xl min-w-min md:w-4/6">
            <div class="bg-purple-600 m-6 drop-shadow-2xl rounded-2xl">
                ...
                <div class="m-6 text-l text-white">
                    ...
                    <b>    Wij zorgen er voor dat de software van u laptop/desktop helemaal uptodate is.</b><br>
                    ...
                    <b>    De basic en pro APK worden uitgevoerd, en de thermal paste/pads worden vervangen van u desktop/laptop.</b><br>
            ...
            <div class="bg-white m-6 shadow-xl rounded-2xl">
                ...
                <div class="m-6 text-l">
                    <b>-   Wij kunnen assisteren bij het bouw procces.</b><br>
                    <b>-   Wij kunnen het procces compleet over nemen, en alles nettjes gebruiks klaar maken.</b><br>
                    ...
                    <b>Wij hanteren een <a class="text-xl" href="/tarieven">uur tarief</a> voor de kosten berekening. (thermal paste voor CPU inbegrepen)</b>
                </div>  
            </div>
            ...
            <div class="bg-white m-6 shadow-xl rounded-2xl">
                ...
                <div class="m-6 text-l">
                    ...
                    <b>-   Als u zelf niet weet wat er aan de hand is met u aparaat,</b><br> 
                    <b>    kunt u Flitserz inhuren voor een diagnose op het angegeven probleem.</b><br>
            ...
            <div class="bg-white m-6 shadow-xl rounded-2xl">
                ...
                <div class="m-6 text-l">
                    ...
                    <b>-   Het helpen uitzoeken van een gepast apparaat gebazeerd op u prijs en wensen.</b><br>
                    <b>-   Een eerlijke mening geven over de gekozen apparaten, dus de voordelen en nadelen benadruken.</b><br>
                    <b>-   De beste prijs voor het gekozen aparaat vinden.</b><br>
                    <b>-   Wanneer u het apparaat (al) binnen hebt, installeren wij het voledig voor u.</b><br>
                    ...
                    <b>    Wij zoeken enkel naar de beste opties voor u, gebazeerd op u verzoek(en). Bijv prijs, functionaliteit en kwaliteit.</b><br>
                    <b>    De keuzen van het product ligt dus bij u, wij doen enkel onderzoek plegen van uit een profesioneel oog.</b><br>
